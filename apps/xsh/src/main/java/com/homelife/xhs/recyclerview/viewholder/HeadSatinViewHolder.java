 ...
 */
@HolderAnnotation(layoutId = R.layout.item_head_satin_holder)
public class HeadSatinViewHolder extends BaseViewHolder<Satin> {
    ...
    public HeadSatinViewHolder(@NonNull View itemView) {
        super(itemView);
                ...
                Glide.with(Static.CONTEXT)
                        ...
                        .into(new SimpleTarget<GlideDrawable>() {
                            ...
                            public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                                ...
                                int imgWidth = (displayTool.getwScreen() - displayTool.dip2px(30));
