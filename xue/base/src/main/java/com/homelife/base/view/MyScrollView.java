...
/**
 * @author Xue
 * @description 自定义弹性滑动scrollview
 * @createDate 2018年07月17日
 */
public class MyScrollView extends ScrollView {
    // 移动因子, 是一个百分比, 比如手指移动了100px, 那么View就只移动50px
    private static final float MOVE_FACTOR = 0.5f; // 目的是达到一个延迟的效果
    ...
    private float startY; // 手指按下时的Y值, 用于在移动时计算移动距离，// 如果按下时不能上拉和下拉， 会在手指移动时更新为当前手指的Y值
