package com.homelife.base.view;
...
public class REditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public interface ClearAllTextListener {
        public void doClearAllText(TextView textView);
    }

    private ClearAllTextListener clearAllTextListener;

    public void setClearAllText(ClearAllTextListener clearAllTextListener) {
        this.clearAllTextListener = clearAllTextListener;
    }
    ...
    public REditText setIconNormal(Drawable icon) {
    ...
    public REditText setIconPressed(Drawable icon) {
    ...
    public REditText setIconUnable(Drawable icon) {
    ...
    public REditText setIconSize(int iconWidth, int iconHeight) {
    ...
    public REditText setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public REditText setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public REditText setIconDirection(int iconDirection) {
    ...
    public REditText setTextColorNormal(int textColor) {
    ...
    public REditText setPressedTextColor(int textColor) {
    ...
    public REditText setTextColorUnable(int textColor) {
    ...
    public REditText setBorderWidthNormal(int width) {
    ...
    public REditText setBorderColorNormal(int color) {
    ...
    public REditText setBorderWidthPressed(int width) {
    ...
    public REditText setBorderColorPressed(int color) {
    ...
    public REditText setBorderWidthUnable(int width) {
    ...
    public REditText setBorderColorUnable(int color) {
    ...
    public REditText setCornerRadiusTopLeft(float topLeft) {
    ...
    public REditText setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public REditText setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public REditText setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
