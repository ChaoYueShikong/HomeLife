 ...
 */
public class BadgeViewNew extends View {
    private Paint numberPaint; //数字paint
    private Paint backgroundPaint; //背景Paint
    ...
    public BadgeViewNew(Context context) {
        super(context);
        init(context);
    }

    public BadgeViewNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BadgeViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BadgeViewNew(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public BadgeViewNew setShape(int shape) {
        currentShape = shape;
        invalidate();
        return this;
    }
     ...
     * @return
     */
    public BadgeViewNew setWidthAndHeight(int w, int h) {
     ...
     * @return
     */
    public BadgeViewNew setWidth(int sp) {
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) getLayoutParams();
    ...
    public BadgeViewNew setHeight(int sp) {
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) getLayoutParams();
     ...
     * @param right
     * @param bottom
     * @return 用setSpace取代该方法
     */
    @Deprecated
    public BadgeViewNew setMargin(int left, int top, int right, int bottom) {
     ...
     * @return
     */
    public BadgeViewNew setSpace(int horitontal, int vertical) {
     ...
     * @return
     */
    public BadgeViewNew setTextSize(int sp) {
    ...
    public BadgeViewNew setTextColor(int color) {
    ...
    public BadgeViewNew setBadgeBackground(int color) {
    ...
    public BadgeViewNew setBadgeCount(int count) {
        if (count > 99) {
            showText = "99+";
        } else {
    ...
    public BadgeViewNew setBadgeCount(String count) {
        showText = count;
        invalidate();
        return this;
    }
     ...
     * @return
     */
    public BadgeViewNew setBadgeGravity(int gravity) {
    ...
    public BadgeViewNew bind(View view) {
        if (getParent() != null)
