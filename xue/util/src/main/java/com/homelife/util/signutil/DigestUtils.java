...
public final class DigestUtils {
     ...
     *
     * @param data
     *            Data to digest; converted to bytes using {@link StringUtil#getBytesUtf8(String)}
     * @return MD2 digest
     * @since 1.7
     */
    public static byte[] md2(final String data) {
        return md2(StringUtil.getBytesUtf8(data));
    }
    ...
    public static byte[] sha256(final String data) {
        return sha256(StringUtil.getBytesUtf8(data));
    }
    ...
    public static byte[] sha384(final String data) {
        return sha384(StringUtil.getBytesUtf8(data));
    }
    ...
    public static byte[] sha512(final String data) {
        return sha512(StringUtil.getBytesUtf8(data));
    }
     ...
     * @param valueToDigest
     *            the value to update the {@link MessageDigest} with;
     *            converted to bytes using {@link StringUtil#getBytesUtf8(String)}
     * @return the updated {@link MessageDigest}
     * @since 1.7
     */
    public static MessageDigest updateDigest(final MessageDigest messageDigest, final String valueToDigest) {
        messageDigest.update(StringUtil.getBytesUtf8(valueToDigest));
        return messageDigest;
    }
}
