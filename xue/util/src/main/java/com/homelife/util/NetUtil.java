...
public final class NetUtil {
     ...
     * * @param context 上下文
     */
    synchronized public static void registerNetConnChangedReceiver(Context context) {
        checkNonNull(context, "context == null");
     ...
     * * @param context 上下文
     */
    synchronized public static void unregisterNetConnChangedReceiver(Context context) {
        //checkNonNull(context, "context == null");
        if(context!=null){
     ...
     */
    synchronized public static void addNetConnChangedListener(NetConnChangedListener listener) {
     ...
     * @param listener 网络连接状态改变监听
     */
    synchronized public static void removeNetConnChangedListener(NetConnChangedListener listener) {
        checkNonNull(listener, "listener == null");
        boolean result = sNetConnChangedListeners.remove(listener);
        log("removeNetConnChangedListener: " + result);
    }

    synchronized private static void broadcastConnStatus(ConnectStatus connectStatus) {
